...
* Implemented the new IGDB v4 authentication method. IGDB will now work again, and requires free credentials. Read more about that [here](docs/SCRAPINGMODULES.md#igdb)
